                        ...
                        <div class="col-md-12 ">
                            <div class="row">
                                ...
                                <div class="col-md-12 collapse in  " id="collapseExample">
                                    <form action="@if(Request::get('type') == 1) {{route('trungUongQuanLy')}} @elseif(Request::get('type') == 2) {{route('thanhUyQuanLy')}} @else {{route('quanUyQuanLy')}} @endif" id="tim_kiem" method="get">
                                        <div class="row">
