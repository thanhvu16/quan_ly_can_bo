<div class="box-body" style=" width: 100%;overflow-x: auto;">
    ...
    <table class="table table-bordered table-striped dataTable mb-0" style="font-size: 12px">
        ...
        <tbody>
        @forelse ($danhSachDangMo as $key=>$data)
            <tr>
                ...
                <td class="text-center" style="vertical-align: middle">
                    <a href="" title="Thêm cán bộ"><i class="fa fa-edit "></i></a>
                </td>
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-6" style="margin-top: 5px">
                Tổng số lớp: <b style="font-size: 16px">{{ $danhSachDangMo->total() }}</b>

            </div>
            <div class="col-md-6 text-right">
                {!! $danhSachDangMo->appends(['ten_cb' => Request::get('ten_cb')])->render() !!}
            </div>
        </div>
    </div>
