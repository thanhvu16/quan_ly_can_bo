                            ...
                            <div class="col-md-12 table-responsive">
                                <table class="table table-bordered table-striped table-hover data-row">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center" width="12%">Duyệt / Trả lại</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button
                                                    ...
                                                    data-id="{{ $data->id }}" data-type="1"><i
                                                        class="fa fa-check"></i> Duyệt
                                                </button>
                                                <button
                                                    class="btn waves-effect btn-danger btn-tra-lai btn-sm mt-1"
                                                    data-toggle="modal"
                                                    data-target="#modal-tra-lai"
                                                    data-id="{{ $data->id }}"
                                                    data-type="2">
                                                    <i class="fa fa-undo"></i> Trả lại hồ sơ
                                                </button>
                                            </td>
                                            <td class="text-center">
                                                <label style="color: red; font-weight: 500 !important;"
                                                       for="checkbox-{{ $data->id }}"> Chọn duyệt:</label><br>
                                                <input id="checkbox-{{ $data->id }}" type="checkbox"
                                                       name="duyet[{{ $data->id }}]" value="{{ $data->id }}"
