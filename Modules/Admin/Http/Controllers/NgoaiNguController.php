...
class NgoaiNguController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $danh_sach = NgoaiNgu::orderBy('ten')
        ...
        return view('admin::ngoai-ngu.index',compact('danh_sach'));
    }
    ...
    {
        $data = NgoaiNgu::where('id', $id)->first();
        return view('admin::ngoai-ngu.edit',compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->mo_ta = $request->mo_ta;
        $data->save();
        return redirect()->route('ngoai-ngu.index')->with('success', 'Cập nhật thành công !');
    }
    ...
    {
        $data = KyLuat::where('id', $id)->delete();
