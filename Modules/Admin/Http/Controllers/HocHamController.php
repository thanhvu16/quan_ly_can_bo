...
use Modules\Admin\Entities\HocHam;
...
class HocHamController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin::hoc-ham.index',compact('danh_sach'));
    }
    ...
    {
        $data = HocHam::where('id', $id)->first();
        return view('admin::hoc-ham.edit',compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->mo_ta = $request->mo_ta;
        $data->save();
        return redirect()->route('hoc-ham.index')->with('success', 'Cập nhật thành công !');
    }
    ...
    {
        $data = HocHam::where('id', $id)->delete();
