...
class TonGiaoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin::ton-giao.index',compact('danh_sach'));
    }
    ...
    {
        $data = TonGiao::where('id', $id)->first();
        return view('admin::ton-giao.edit',compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->mo_ta = $request->mo_ta;
        $data->save();
        return redirect()->route('ton-giao.index')->with('success', 'Cập nhật thành công !');
    }
    ...
    {
        $data = TonGiao::where('id', $id)->delete();
