...
class TinHocController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin::tin-hoc.index',compact('danh_sach'));
    }
    ...
    {
        $data = TinHoc::where('id', $id)->first();
        return view('admin::tin-hoc.edit',compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->mo_ta = $request->mo_ta;
        $data->save();
        return redirect()->route('tin-hoc.index')->with('success', 'Cập nhật thành công !');
    }
    ...
    {
        $data = TinHoc::where('id', $id)->delete();
