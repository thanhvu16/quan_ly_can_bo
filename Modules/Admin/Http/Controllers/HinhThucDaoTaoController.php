...
class HinhThucDaoTaoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $danh_sach = HinhThucDaoTao::orderBy('ten')
        ...
        return view('admin::hinh-thuc-dao-tao.index',compact('danh_sach'));
    }
    ...
    {
        $data = HinhThucDaoTao::where('id', $id)->first();
        return view('admin::hinh-thuc-dao-tao.edit',compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->mo_ta = $request->mo_ta;
        $data->save();
        return redirect()->route('hinh-thuc-dao-tao.index')->with('success', 'Cập nhật thành công !');
    }
    ...
    {
        $data = HinhThucDaoTao::where('id', $id)->delete();
