...
class DanhHieuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $danh_sach = DanhHieu::orderBy('ten')
        ...
        return view('admin::danh-hieu.index',compact('danh_sach'));
    }
    ...
    {
        $data = DanhHieu::where('id', $id)->first();
        return view('admin::danh-hieu.edit',compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->mo_ta = $request->mo_ta;
        $data->save();
        return redirect()->route('danh-hieu.index')->with('success', 'Cập nhật thành công !');
    }
    ...
    {
        $data = DanhHieu::where('id', $id)->delete();
