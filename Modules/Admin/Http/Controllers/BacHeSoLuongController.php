...
class BacHeSoLuongController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $danh_sach = BacHeSoLuong::orderBy('ten')
        ...
        return view('admin::bac-he-so-luong.index',compact('danh_sach'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin::bac-he-so-luong.edit',compact('data'));
    }
    ...
    {
        $data = BacHeSoLuong::where('id', $id)->delete();
