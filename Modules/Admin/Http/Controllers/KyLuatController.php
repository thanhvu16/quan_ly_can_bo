...
class KyLuatController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin::ky-luat.index',compact('danh_sach'));
    }
    ...
    {
        $data = KyLuat::where('id', $id)->first();
        return view('admin::ky-luat.edit',compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->mo_ta = $request->mo_ta;
        $data->save();
        return redirect()->route('ky-luat.index')->with('success', 'Cập nhật thành công !');
    }
