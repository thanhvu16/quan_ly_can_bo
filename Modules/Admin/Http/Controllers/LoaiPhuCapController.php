...
class LoaiPhuCapController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $danh_sach = LoaiPhuCap::orderBy('ten')
        ...
        return view('admin::loai-phu-cap.index',compact('danh_sach'));
    }
    ...
    {
        $data = LoaiPhuCap::where('id', $id)->first();
        return view('admin::loai-phu-cap.edit',compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->mo_ta = $request->mo_ta;
        $data->save();
        return redirect()->route('loai-phu-cap.index')->with('success', 'Cập nhật thành công !');
    }
    ...
    {
        $data = LoaiPhuCap::where('id', $id)->delete();
