            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="collapse " id="collapseExample">
                                <div class="row">
                                    <form role="form" action="{{route('cap-to-chuc.store')}}" method="post" enctype="multipart/form-data"
                                          id="myform">
                                        @csrf
                                        <div class="box-body">
                                            <div class="col-md-3">
                    ...
                    <div class="col-md-12" style="margin-top: 20px">
                        <div class="row">
                            <form action="{{route('cap-to-chuc.index')}}" method="get">
                                    ...
                                    <td class="text-center">
                                        <form method="POST" action="{{route('xoacaptochuc',$data->id)}}">
                                            ...
                                            <a class="btn-action btn btn-color-blue btn-icon btn-light btn-sm"
                                               href="{{route('cap-to-chuc.edit',$data->id)}}" role="button" title="Sửa">
