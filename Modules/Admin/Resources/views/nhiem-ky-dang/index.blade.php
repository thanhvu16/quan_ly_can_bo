...
@section('page_title', 'nhiệm kỳ đảng')
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Danh sách nhiệm kỳ đảng</h3>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="collapse " id="collapseExample">
                                <div class="row">
                                    <form role="form" action="{{route('nhiem-ky-dang.store')}}" method="post" enctype="multipart/form-data"
                                          id="myform">
                                        @csrf
                                        <div class="box-body">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Tên nhiệm kỳ đảng</label>
                                                    <input type="text" class="form-control" name="ten" id="exampleInputEmail1"
                                                           placeholder="Tên nhiệm kỳ đảng" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                    ...
                    <div class="col-md-12" style="margin-top: 20px">
                        <div class="row">
                            <form action="{{route('nhiem-ky-dang.index')}}" method="get">

                                <div class="col-md-3 form-group">
                                    <label for="exampleInputEmail1">Tìm theo tên nhiệm kỳ đảng</label>
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <th width="" class="text-center">Tên nhiệm kỳ đảng</th>
                            ...
                            @forelse($danh_sach as $key=>$data)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form method="POST" action="{{route('xoankdang',$data->id)}}">
                                            @csrf
                                            <a class="btn-action btn btn-color-blue btn-icon btn-light btn-sm"
                                               href="{{route('nhiem-ky-dang.edit',$data->id)}}" role="button" title="Sửa">
