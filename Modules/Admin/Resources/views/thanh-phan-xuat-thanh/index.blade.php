...
@section('page_title', 'thành phần xuất thân')
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Danh sách thành phần xuất thân</h3>
                    </div>
                    <div class="col-md-3 form-group mt-4">
                        <button type="button" class="btn btn-sm btn-info waves-effect waves-light mb-1"
                            ...
                            THÊM THÀNH PHẦN XUẤT THÂN</button>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="collapse " id="collapseExample">
                                <div class="row">
                                    <form role="form" action="{{route('thanh-phan-xuat-than.store')}}" method="post" enctype="multipart/form-data"
                                          id="myform">
                                        @csrf
                                        <div class="box-body">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Tên thành phần xuất thân</label>
                                                    <input type="text" class="form-control" name="ten" id="exampleInputEmail1"
                                                           placeholder="Tên thành phần xuất thân" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                    ...
                    <div class="col-md-12" style="margin-top: 20px">
                        <div class="row">
                            <form action="{{route('thanh-phan-xuat-than.index')}}" method="get">

                                <div class="col-md-3 form-group">
                                    <label for="exampleInputEmail1">Tìm theo tên thành phần xuất thân</label>
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <th width="" class="text-center">Tên thành phần xuất thân</th>
                                    ...
                                    <td class="text-center">
                                        <form method="POST" action="{{route('xoaxuatthan',$data->id)}}">
                                            ...
                                            <a class="btn-action btn btn-color-blue btn-icon btn-light btn-sm"
                                               href="{{route('thanh-phan-xuat-than.edit',$data->id)}}" role="button" title="Sửa">
