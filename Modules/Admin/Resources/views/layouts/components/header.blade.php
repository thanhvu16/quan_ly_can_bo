        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu ">
                    <a href="#" class="dropdown-toggle bat-thong-bao" data-toggle="dropdown" aria-expanded="true">
                        <i class="fa fa-bell-o"></i>
                        <span class="label label-warning"><span class="so-thong-bao"></span></span>
                    </a>
                    <ul class="dropdown-menu thong-bao-cha">
                        <li class="header text-center" style="font-weight: bold">Thông báo</li>
                        <li>

                            <ul class="menu them-thong-bao" >


                            </ul>
                        </li>
                        <li class="footer"><a href="#"><i class="fa fa-trash btn-color-red"></i> Xóa tất cả thông báo</a></li>
                    </ul>
                </li>
