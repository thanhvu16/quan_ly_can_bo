            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="collapse " id="collapseExample">
                                <div class="row">
                                    <form role="form" action="{{route('binh-bau-phan-loai-can-bo.store')}}" method="post" enctype="multipart/form-data"
                                          id="myform">
                                        @csrf
                                        <div class="box-body">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Tên loại cán bộ</label>
                                                    <input type="text" class="form-control" name="ten" id=" exampleInputEmail1"
                                                           placeholder="Tên loại cán bộ" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                    ...
                    <div class="col-md-12" style="margin-top: 20px">
                        <div class="row">
                            <form action="{{route('binh-bau-phan-loai-can-bo.index')}}" method="get">

                                <div class="col-md-3 form-group">
                                    <label for="exampleInputEmail1">Tìm theo tên loại cán bộ</label>
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <th width="" class="text-center">Tên loại cán bộ</th>
                            ...
                            @forelse($danh_sach as $key=>$data)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form method="POST" action="{{route('xoabinhbau',$data->id)}}">
                                            @csrf
                                            <a class="btn-action btn btn-color-blue btn-icon btn-light btn-sm"
                                               href="{{route('binh-bau-phan-loai-can-bo.edit',$data->id)}}" role="button" title="Sửa">
