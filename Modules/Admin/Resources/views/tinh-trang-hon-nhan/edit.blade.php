...
@section('page_title', 'tình trạng hôn nhân')
@section('content')
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Cập nhật tình trạng hôn nhân</h3>
                    </div>
                    <form action="{{route('tinh-trang-hon-nhan.update',$data->id)}}" method="post" enctype="multipart/form-data"
                          id="myform">
                        @method('PUT')
                        @csrf
                        <div class="box-body">
