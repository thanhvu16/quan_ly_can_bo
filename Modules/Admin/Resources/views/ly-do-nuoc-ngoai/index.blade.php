            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Danh sách lý do đi nước ngoài</h3>
                    </div>
                    <div class="col-md-3 form-group mt-4">
                        <button type="button" class="btn btn-sm btn-info waves-effect waves-light mb-1"
                            ...
                            THÊM LÝ DO ĐI NƯỚC NGOÀI</button>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="collapse " id="collapseExample">
                                <div class="row">
                                    <form role="form" action="{{route('ly-do-di-nuoc-ngoai.store')}}" method="post" enctype="multipart/form-data"
                                          id="myform">
                                        @csrf
                                        <div class="box-body">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="ten" id="exampleInputEmail1"
                                                           placeholder="Tên lý do đi nước ngoài" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                    ...
                    <div class="col-md-12" style="margin-top: 20px">
                        <div class="row">
                            <form action="{{route('ly-do-di-nuoc-ngoai.index')}}" method="get">

                                <div class="col-md-3 form-group">
                                    <label for="exampleInputEmail1">Tìm theo tên lý do đi nước ngoài</label>
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <th width="" class="text-center">Tên lý do đi nước ngoài</th>
                            ...
                            @forelse($danh_sach as $key=>$data)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form method="POST" action="{{route('xoacnuocngoai',$data->id)}}">
                                            @csrf
                                            <a class="btn-action btn btn-color-blue btn-icon btn-light btn-sm"
                                               href="{{route('ly-do-di-nuoc-ngoai.edit',$data->id)}}" role="button" title="Sửa">
