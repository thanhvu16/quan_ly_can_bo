...
@section('page_title', 'lý lịch chính trị')
@section('content')
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Cập nhật lý lịch chính trị</h3>
                    </div>
                    <form action="{{route('chinh-tri.update',$data->id)}}" method="post" enctype="multipart/form-data"
                          id="myform">
                        @method('PUT')
                        @csrf
                        <div class="box-body">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tên lý lịch chính trị</label>
