<div class="modal fade" id="myModal8">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('quaTrinhKiemNhiem',$canBo->id ) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-3" >
                            <div class="form-group">
                                <label for="exampleInputEmail6">Cán bộ </label>
                                <div class="form-group">
                                    <select class="form-control select2" name="biet_phai">
                                        <option value="">--Lựa chọn--</option>
                                        @foreach($kiemNhiem as $dsquaTrinhKiemNhiemBietphai)
                                            <option value="{{$dsquaTrinhKiemNhiemBietphai->id}}" {>{{$dsquaTrinhKiemNhiemBietphai->ten}}</option>
                                        @endforeach
                                    </select>
