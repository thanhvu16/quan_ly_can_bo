                            ...
                            <div class="col-md-6">
                                <form action="{{route('danh-gia-can-bo.index')}}" method="get">
                                    <select
                                        ...
                                        @for($i = 1; $i <= 12; $i++)
                                            <option
                                                value="{{ $i }}" @if(empty(Request::get('thang_danh_gia')) && $i == $month) selected @elseif(Request::get('thang_danh_gia') == $i) selected @endif >
                                                Tháng {{ $i }}</option>
                                        @endfor
...
{{--                                                    @if(count($nguoinhan) > 0)--}}
{{--                                                        @forelse($nguoinhan as $nguoi_nhan)--}}
{{--                                                            <option--}}
