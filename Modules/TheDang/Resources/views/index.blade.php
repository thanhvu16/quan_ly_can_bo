            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Lập danh sách đợt cấp thẻ đảng</h3>
                    </div>
                    ...
                    <div class="col-md-12" style="margin-top: 20px">
                        <div class="row">
                            <form action="{{route('cap-the-dang.index')}}" method="get">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-3" style="max-height:650px;  overflow:auto">
                                <form action="{{route('cap-the-dang.store')}}" id="can-bo" method="POST">
                                    @csrf
...
{{--                                        </div>--}}
                            ...
                            <div class="col-md-9" style="max-height:650px;  overflow:auto">
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                    <tr>
                                        <th class="text-center" colspan="8" style="vertical-align: middle" width="3%">Danh sách cán bộ chờ duyệt cấp thẻ đảng</th>
