            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <div class="col-md-6">
                            <div class="row">
                                <h3 class="box-title">Danh sách văn bản quy định</h3>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <a class=" btn btn-primary" data-toggle="collapse" href="#collapseExample"
                                   aria-expanded="false" aria-controls="collapseExample"> <i class="fa  fa-plus-square-o"></i> <span
                                        style="font-size: 14px">{{isset($vanBanfisst) ? 'Sửa văn bản' : 'Thêm văn bản'}}</span></a>
                            </div>
                            <div class="col-md-6 text-right">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="row">
                            <div class="col-md-12 collapse {{ $vanBanfisst ? 'in' : '' }} " id="collapseExample">
                                <form action="{{isset($vanBanfisst) ? route('van-ban-quy-dinh.update',$vanBanfisst->id) : route('van-ban-quy-dinh.store')}}"  method="post" enctype="multipart/form-data" >
                                    @csrf
                                    @if($vanBanfisst)
                                    @method('PUT')
                                    @endif
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="co_quan_ban_hanh"
                                                       id="co-quan-ban-hanh" value="{{isset($vanBanfisst) ? $vanBanfisst->co_quan_ban_hanh : ''}}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="so_ky_hieu" value="{{isset($vanBanfisst) ? $vanBanfisst->so_ky_hieu : ''}}" id="so-ky-hieu-vb" style="text-transform: uppercase "
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date">
                                                    <input type="text" class="form-control  datepicker" value="{{isset($vanBanfisst) ? formatDMY($vanBanfisst->ngay_ban_hanh) : ''}}"
                                                           name="ngay_ban_hanh" id="ngay-ban-hanh-vb" autocomplete="off"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nguoi_ky" value="{{isset($vanBanfisst) ?  $vanBanfisst->nguoi_ky : ''}}" id="nguoi-ky"
                                                       placeholder="Người ký" required>
                                            </div>
                                        </div>
                                        @if($vanBanfisst == null)
                                        <div class="col-md-3">
                                            <label for="exampleInputEmail4">File văn bản</label>
                                        ...
                                        <div class="col-md-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="trich_yeu" id="trich-yeu" rows="3" required>{{isset($vanBanfisst) ? $vanBanfisst->trich_yeu : ''}}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 mt-4">
                                            <div class="form-group">
                                                <button type="submit"  class="btn btn-primary"><i
                                                        class="fa fa-plus-square-o mr-1"></i> {{isset($vanBanfisst) ? 'Cập nhật' : 'Thêm mới'}}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="box-body" style=" width: 100%;overflow-x: auto;">
                        Tổng số văn bản: <b style="font-size: 16px">{{count($vanBan)}}</b>
                        <table class="table table-bordered table-striped dataTable mb-0">
                            <thead>
                            <tr>
                                <th width="2%" style="vertical-align: middle" class="text-center">STT</th>
                                <th width="10%"  style="vertical-align: middle"class="text-center">Cơ quan ban hành</th>
                                ...
                                <th width="13%"  style="vertical-align: middle"class="text-center">Người ký</th>
                            ...
                            <tbody>
                            @forelse ($vanBan as $key=>$vb)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td class="text-left">{{$vb->co_quan_ban_hanh}}</td>
                                    <td class="text-left">{{$vb->so_ky_hieu}}</td>
                                    <td class="text-center">{{ date('d/m/Y', strtotime($vb->ngay_ban_hanh)) }}</td>
                                    <td class="text-left">{{$vb->nguoi_ky}}</td>
                                    <td class="text-left">{{$vb->trich_yeu}}</td>
                                    <td class="text-center"><a href="{{$vb->getUrlFile()}}" target="popup" class="seen-new-window">[File_van_ban]</a></td>
                                    <td class="text-center">
                                        <form method="POST" action="{{route('xoavb',$vb->id)}}">
                                            @csrf
                                            <a href="{{route('van-ban-quy-dinh.index','id='.$vb->id)}}"
